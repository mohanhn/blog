...
require_once("mohan_membersite.php");

$fgmembersite = new FGMembersite();

//Provide your site name here
// $fgmembersite->SetWebsiteName('www.mohancrud.com');

//Provide the email address where you want to get notifications
// $fgmembersite->SetAdminEmail('mohan.ningappanavar@gmail.com');
